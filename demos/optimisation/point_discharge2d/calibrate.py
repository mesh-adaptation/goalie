...
# FIXME: Rate is only linear
# perturbation = Function(mesh_seq.function_spaces["r"][0]).assign(0.01)
# mesh_seq.taylor_test("r", perturbation=perturbation)
...
fig, axes = plt.subplots()
axes.loglog(optimiser.progress["count"], optimiser.progress["qoi"], "--x")
axes.set_xlabel("Iteration")
axes.set_ylabel("QoI")
axes.grid(True)
