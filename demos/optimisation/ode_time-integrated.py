# ODE-constrained optimisation with time-integrated QoI
# =====================================================
#
# We consider the same problem as in `the previous demo <./ode_end-time.py.html>`__,
# except that we use a time-integrated QoI rather than one evaluated at the end time.
...
# Recall that we need to modify the solver to account for time-integrated QoIs. ::
...
# Again, print initial field values. ::
...
# As before, we see that 'u' and 'theta' are initialised to 1.0 and 0.0 respectively:
#
# .. code-block:: none
#
#     u_0 = 1.0000e+00
...
#
# Store the trajectory as Forward Euler, to be compared later. ::
...
# Again, specify parameters for the optimisation and then run the optimisation using the
...
axes.grid(True)
plt.savefig("ode_time-integrated_control.jpg", bbox_inches="tight")
...
axes.set_ylabel("QoI")
axes.grid(True)
plt.savefig("ode_time-integrated_qoi.jpg", bbox_inches="tight")

# TODO: comment
# .. figure:: ode_time-integrated_control.jpg
#   :figwidth: 70%
#   :align: center
#
# .. figure:: ode_time-integrated_qoi.jpg
#   :figwidth: 70%
#   :align: center
#
...
axes.legend()
plt.tight_layout()
plt.savefig("ode_time-integrated_optimised.jpg", bbox_inches="tight")

# TODO: comment
# .. figure:: ode_time-integrated_optimised.jpg
#   :figwidth: 70%
#   :align: center
#
...
#
# This demo can also be accessed as a `Python script <ode_time-integrated.py>`__.
