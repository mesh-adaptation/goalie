...
plt.savefig("opt-turbine_forward.jpg", bbox_inches="tight")
fig, axes = plt.subplots(figsize=(12, 5))
...
plt.savefig("opt-turbine_adjoint.jpg", bbox_inches="tight")
...
axes.grid(True)
plt.savefig("opt-turbine_control.jpg", bbox_inches="tight")
...
axes.set_ylabel("QoI")
axes.grid(True)
plt.savefig("opt-turbine_qoi.jpg", bbox_inches="tight")
